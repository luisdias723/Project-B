...
const whiteList = ['/login', '/registar', '/password', '/registar/form', '/recuperar/password', '/auth-redirect', '/termos', 'privacidade']; // no redirect whitelist
